...
/* ==============================================================
 * TODO 1: Define your linked-list node struct.  (FILLED IN)
 *
 * Requirements:
...
struct monitored_entry {
    ...
    int            soft_warned;          /* set to 1 after first soft-limit event */
    char           container_id[MONITOR_NAME_LEN];
    struct list_head list;               /* kernel doubly-linked list linkage */
};

/* ==============================================================
 * TODO 2: Declare the global monitored list and a lock.  (FILLED IN)
 *
 * Requirements:
...
{
    /* ==============================================================
     * TODO 3: Implement periodic monitoring.  (FILLED IN)
     *
     * Requirements:
...
static long monitor_ioctl(struct file *f, unsigned int cmd, unsigned long arg)
{
    ...
    if (cmd == MONITOR_REGISTER) {
        ...
        /* ==============================================================
         * TODO 4: Add a monitored entry.  (FILLED IN)
         *
         * Requirements:
    ...
    /* ==============================================================
     * TODO 5: Remove a monitored entry on explicit unregister.  (FILLED IN)
     *
     * Requirements:
...

    {
        ...
        list_for_each_entry_safe(entry, tmp, &monitored_list, list) {
            if (entry->pid == req.pid) {
                ...
                kfree(entry);
                found = 1;
                break; /* PID is unique, no need to continue */
            }
        }
        mutex_unlock(&monitored_lock);
...
static void __exit monitor_exit(void)
{
    ...
    /* ==============================================================
     * TODO 6: Free all remaining monitored entries.  (FILLED IN)
     *
     * Requirements:
